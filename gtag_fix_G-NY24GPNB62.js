		...
		resource: {
			...
			tags: [
				...
				},
				{
					...
					priority: 12,
					vtp_instanceDestinationId: 'G-NY24GPNB62',
					tag_id: 18,
				},
				{
...
*/
	...
	function pc(a, b, c, d, e) {
		...
		var n,
			p,
			q =
				(p = (n = 'document' in m ? m.document : m).querySelector) ==
				null
					? void 0
	...
	function Dc(a, b, c) {
		if (Ec()) {
			...
			try {
				// console.log('DCsend fetch input', a);
				// console.log('DCsend fetch init', d);
				var e = C.fetch(a, d);
				e && e.catch(ab);
				return !0;
			} catch (f) {}
...
*/
	var Rc = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/,
		...
		Uc = function (a) {
			if (!a || Sc(a) != 'object' || a.nodeType || a == a.window)
				return !1;
			try {
				if (
					a.constructor &&
		...
		var d = dd(),
			...
			f = function (g) {
				...
				if (g instanceof $c) {
					var r = function () {
						for (
							var v = ya.apply(0, arguments), t = 0;
							t < v.length;
							t++
						)
							v[t] = hd(v[t], b, c);
			...
			f = function (g) {
				...
				if (typeof g === 'function') {
					var q = new $c('', function () {
						for (
							var x = ya.apply(0, arguments), y = 0;
							y < x.length;
							y++
						)
	...
	function qd(a, b, c) {
		...
		if (a instanceof $c || a instanceof La || a instanceof gd) {
			...
			if (b === 'toString')
				return a instanceof $c ? a.getName() : a.toString();
			...
			(function () {
				return function () {
					...
					for (var k = 0; k < f.length; k++)
						if (((f[k] = this.evaluate(f[k])), f[k] instanceof Aa))
							return f[k];
					for (var m = e.get('length'), n = 0; n < m; n++)
						n < f.length
							? g.add(e.get(n), f[n])
							: g.add(e.get(n), void 0);
	...
	bg.prototype.aa = function (a) {
		...
		return (
			...
			c.every(function (d) {
				return (
					a.ja.hasOwnProperty(d) &&
					String(b.ja[d]) === String(a.ja[d])
				);
			})
		);
	};
			...
			if (c) {
				...
				switch (d) {
					case 'hitData':
						return a.length < 2
							? void 0
							: Sg(c.getHitData(a[1]), a.slice(2));
					case 'metadata':
						return a.length < 2
							? void 0
							: Sg(c.getMetadata(a[1]), a.slice(2));
					case 'eventName':
	...
	ih.keys = function (a) {
		...
		if (a instanceof Yc || a instanceof $c || typeof a === 'string')
			a = jh(a);
	...
	var hi = function (a) {
		...
		xi = function (a) {
			...
			function e(r, u, v) {
				for (var t = db(d(r, u)), w = 0; w < t.length; ++w)
					b(t[w], u, v);
			}
			function f(r, u, v, t) {
				var w = d(r, u);
	...
	Hi.ob = 'dataLayer';
	Hi.Cn =
		'ChAIgOexuQYQ4eLQoJWC1YAXEiUACzQCYRR3GZRdkqSvxABHmPMO5QH/vkCB1CcwmqAIOx4bf8lzGgJ4Ng\x3d\x3d';
	var Ji = {
			__cl: 1,
			__ecl: 1,
			__ehl: 1,
	...
	function ak() {
		...
		c.injectedFirstPartyContainers ||
			(c.injectedFirstPartyContainers = bk());
		return c;
	}
	var dk = {},
		ek = !1,
		Pf = {
			ctid: 'G-NY24GPNB62',
			canonicalContainerId: '198006279',
			qk: 'G-NY24GPNB62|GT-MB88HFH2',
			rk: 'G-NY24GPNB62',
		};
	dk.ze = mb('');
	function fk() {
			...
			var a = Pf.ctid,
				...
				d = function (n, p) {
					...
					var W = p ? e.destination : e.container,
						N = W[n];
					N
						? (p && N.state === 0 && U(93), Object.assign(N, q))
						: (W[n] = q);
				},
				e = ak(),
				f = l(b),
	...
	function Jk(a) {
		...
		var b = Object.keys(Fk)
			.filter(function (c) {
				return (
					Fk[c] === !0 && Gk[c] !== void 0 && (a || !Ek.includes(c))
				);
			})
			.map(function (c) {
				var d = Gk[c];
			...
			.join('');
		return (
			'' + Jj('https://www.googletagmanager.com') + Ck + ('' + b + '&z=0')
		);
	}
	function Kk() {
	...
	function Ll(a) {
		if (!Kl) {
			Kl = {};
			for (
				var b = l(Object.keys(Jl)), c = b.next();
				!c.done;
				c = b.next()
			)
				Kl[Jl[c.value]] = !0;
	...
	function Ml(a, b) {
		...
		if (Ll(a)) {
			var c,
				d,
				e =
					(d = (c = kc('google_tag_data', {})).xcd) != null
						? d
						: (c.xcd = {});
			if (e[a]) return e[a];
			if (b) {
	...
	function Nm() {
		...
		if (Hm !== void 0 && Om) {
			var a;
			(a = Im[Hm]) ||
				(a = Km.j < Km.C ? !1 : qb() - Km.H[Km.j % Km.C] < 1e3);
	...
	en.prototype.push = function (a, b, c, d) {
		// console.log('en.prototype.push', a, b, c, d);
	...
	en.prototype.flush = function (a) {
		// console.log('en.prototype.flush', a);
			...
			if (f.messageContext.deferrable)
				...
				switch (f.type) {
					...
					case 'event':
						...
						// console.log('fn', f.args[1], e.Kh, f);
	...
	function Fo(a) {
		...
		var n = b,
			p =
				(ol() === 'US-CO' && gc.globalPrivacyControl === !0 ? 1 : 0) <<
				3,
			q = (bl() ? 1 : 0) << 2,
			r = yo(a);
		b =
	...
	function Go() {
		...
		(Xk.usedCorePlatformServices
			? Xk.selectedAllCorePlatformServices
			: 1) && (c += 'o');
		return c || '-';
	}
	function Ho() {
	...
	function Uo(a, b, c) {
		for (
			var d = [], e = Qo(a, void 0, void 0, c), f = 0;
			f < e.length;
			f++
		) {
			var g = e[f].split('.'),
	...
	function $o(a, b) {
		return (
			a !== void 0 &&
			(cp.test(window.document.location.hostname) ||
				(b === '/' && bp.test(a)))
		);
	}
	function dp(a) {
		...
		if (a && typeof a === 'object')
			if ('expires' in a && 'value' in a) {
				...
				typeof a.expires === 'number'
					? (b = a.expires)
					: (b =
							typeof a.expires === 'string'
								? Number(a.expires)
								: NaN);
				(!isNaN(b) && Date.now() <= b) ||
					((a.value = null), (a.error = 9));
			} else
				for (
					var c = l(Object.keys(a)), d = c.next();
					!d.done;
					d = c.next()
				)
					sq(a[d.value]);
	...
	function Qq(a, b, c) {
		...
		return !f.value || (e !== void 0 && e !== 'aw' && e !== 'aw.ds')
			? []
			: [f];
	}
	function Rq(a, b) {
					...
					if (!n && a.gb) {
						...
						(!b &&
							Bq(A).some(function (H) {
								return (
									H.W === y && H.labels && H.labels.length > 0
								);
							})) ||
							u('gb', v(y));
					}
	...
	function nr(a) {
		for (
			var b = 0, c = l(Object.keys(a)), d = c.next();
			!d.done;
			d = c.next()
		)
				...
				sr(function () {
					...
					if (v) {
						...
						if (B.length !== 0 || r !== void 0) {
							...
							t.push('frm=' + J);
							r !== void 0 &&
								t.push('gad_source=' + encodeURIComponent(r));
							u !== void 0 &&
								t.push(
									'gad_source_src=' +
					...
					if (e) a.isAborted = !0;
						...
						if (a.metadata.consent_updated)
							...
							a.j[O.g.Td] ||
								...
								((a.j[O.g.zf] = k.wbraid),
								(a.j[O.g.Ag] = k.gbraid));
							a.j[O.g.Fa] = E.referrer
								? vj(Bj(E.referrer), 'host')
								: '';
							a.j[O.g.wa] = wr();
							if (S(23) && jc) {
								var m = vj(Bj(jc), 'host');
	...
	var Ws = function (a) {
			if (Us) {
				if (a >= 0 && a < Vs.length && Vs[a]) {
					var b;
					(b = Vs[a]) == null || b.disconnect();
					Vs[a] = void 0;
				}
		...
		Zs = function (a, b, c) {
			...
			return C.setInterval(Xs(a, b, c), 1e3);
		},
		Xs = function (a, b, c) {
			function d(k, m) {
				var n = {
		...
		Ys = function (a, b, c) {
			...
			for (var f = 0; f < Vs.length; f++)
				if (!Vs[f]) return (Vs[f] = d), f;
			return Vs.push(d) - 1;
		},
		Vs = [],
		Us = !(!C.IntersectionObserver || !C.IntersectionObserverEntry);
	var at = function (a) {
			return (
				a.tagName +
				':' +
			...
			if (d) c(d);
				...
				if (e) {
					...
					var f = C.setTimeout(function () {
						c.Ze ||
							((c.Ze = !0), U(106), c(null, Error('Timeout')));
					}, b);
					e.then(function (g) {
	...
	kx.prototype.addListener = function (a, b, c) {
		var d = ++this.H;
		this.j[a] = this.j[a] || {};
		this.j[a][String(d)] = { listener: b, Ib: c };
		return d;
	};
	kx.prototype.removeListener = function (a, b) {
		var c = this.j[a],
			d = String(b);
		if (!c || !c[d]) return !1;
		delete c[d];
	...
	var dy = function (a, b) {
		...
		var c = a['gtm.triggers'] && String(a['gtm.triggers']),
			d = cy.C(a.event, c ? String(c).split(',') : []);
		...
		Wy = {
			config: function (a, b) {
				...
				if (!(a.length < 2) && z(a[1])) {
					var d = {};
					if (a.length > 2) {
						if ((a[2] !== void 0 && !Uc(a[2])) || a.length > 3)
							return;
						d = a[2];
					}
					...
					if (e) {
						...
						var r = e.destinationId,
							u = e.id !== r;
						if (
							u ? kk().indexOf(r) === -1 : hk().indexOf(r) === -1
						) {
							...
							if (
								f &&
								(U(128), g && U(130), b.inheritParentConfig)
							) {
								var w;
								var x = d;
								Sy
			...
			event: function (a, b) {
				...
				if (!(a.length < 2) && z(c)) {
					var d = void 0;
					if (a.length > 2) {
						if ((!Uc(a[2]) && a[2] !== void 0) || a.length > 3)
							return;
						d = a[2];
					}
					var e = d,
						...
						for (var I = [], J = 0; J < B.length; J++) {
							...
							if (Ly.indexOf(rk(H.prefix)) !== -1) {
								...
								aa.hasOwnProperty('is_external_event') ||
									(aa.is_external_event =
										!W.fromContainerExecution);
								W.eventMetadata = aa;
								delete N[O.g.kd];
								// console.log(
								// 	' Ym(c, N, H.id, W)',
								...
								Ym(c, N, H.id, W);
								// console.log('Ym(c, N, H.id, W) After');
								Rj &&
									!ek &&
									ly === 0 &&
									(Hk('mcc', '1'), (ly = 1));
	...
	Zy.prototype.getUntrustedMessageValue =
		Zy.prototype.getUntrustedMessageValue;
	var $y = !1,
		az = [];
	function bz() {
						...
						if (kb(d))
							a: {
								if (d.length && z(d[0])) {
									...
									if (
										p &&
										(!e.fromContainerExecution || !Xy[d[0]])
									) {
										// console.log('qz n = p(d, e)', d, e);
	...
	var OA = {},
		...
		SA = 0;
	var UA = function () {
			uc(E, 'change', function (a) {
				for (var b = 0; b < PA.length; b++) PA[b](a);
			});
			uc(C, 'pagehide', function () {
				TA();
			});
		},
		TA = function () {
			...
			if (OA[c]) OA[c].push(b);
				...
				PA.push(function (f) {
					...
					if (g) {
						var k = GA(g);
						if (k) {
							var m = WA(k, 'gtmFormInteractId', function () {
									return RA++;
								}),
								n = WA(
									g,
							...
							p
								? (p.Xb &&
										(C.clearTimeout(p.Xb),
										p.Eb.dataset.gtmFormInteractFieldId !==
											n && VA(p, d)),
								  (p.Eb = g),
								  XA(p, d, a))
		...
		VA = function (a, b) {
			...
			e['gtm.interactedFormFieldPosition'] = FA(
				c,
				d,
				'gtmFormInteractFieldId'
			);
	...
	var aB = function (a, b, c) {
		...
		bB = function (a, b) {
			var c = yA('pix.fsl', a ? 'nv.mwt' : 'mwt', 0);
			C.setTimeout(b, c);
		},
		cB = function (a, b, c, d, e) {
			var f = yA('pix.fsl', c ? 'nv.mwt' : 'mwt', 0),
				g = yA('pix.fsl', c ? 'runIfCanceled' : 'runIfUncanceled', []);
		...
		eB = function () {
			...
			uc(
				...
				function (c) {
					...
					if (cB(d, m, e, f, g)) return (k = !1), c.returnValue;
					bB(e, m);
					e ||
			...
			HTMLFormElement.prototype.submit = function () {
				...
				cB(c, e, !1, $A(c)) ? (b.call(c), (d = !1)) : bB(!1, e);
			};
		};
	function fB(a, b) {
		...
		if (d) {
			...
			CA('pix.fsl', 'mwt', k, 0);
			f || CA('pix.fsl', 'nv.mwt', k, 0);
		}
		var m = function (n) {
			n.push(g);
			return n;
		};
		CA('pix.fsl', 'runIfUncanceled', m, []);
		f || CA('pix.fsl', 'runIfCanceled', m, []);
		yA('pix.fsl', 'init') || (eB(), zA('pix.fsl', 'init', !0));
	}
					...
					if (c)
						if (oC)
							new MutationObserver(function () {
								for (var e = 0; e < nC.length; e++) F(nC[e]);
			...
			if (wC[c]) wC[c].push(a);
				...
				xC.push(function (f) {
					...
					if (g) {
						var k = GA(g);
						if (k) {
							var m = DC(k, 'gtmFormInteractId', function () {
									return zC++;
								}),
								n = DC(
									g,
	...
	function GC(a, b) {
		...
		if (yA('fil', 'init', !1)) {
			...
			uc(E, 'change', function (f) {
				for (var g = 0; g < xC.length; g++) xC[g](f);
			}),
				uc(C, 'pagehide', function () {
					CC();
				}),
	...
	function ZC(a, b) {
		...
		if (!yA(d, 'init', !1)) {
			...
			d === 'ehl'
				? ((f = function (k) {
						for (var m = 0; m < SC.length; m++) SC[m](k);
				  }),
				  (b = xA(b)),
				  UC(b, e),
				  zA(d, 'reg', UC))
				: (f = TC('gtm.historyChange'));
			YC(f);
			XC(f);
			VC('pushState', f);
			VC('replaceState', f);
	...
	var gD = function (a) {
		...
		lD = function () {
			function a() {
				f ? (e = C.setTimeout(a, c)) : ((e = 0), iD(), jD(b));
				f = !1;
			}
			function b() {
				d && eD();
				e
					? (f = !0)
					: ((e = C.setTimeout(a, c)), zA('sdl', 'pending', !0));
			}
			var c = 250,
				d = !1;
		...
		jD = function (a, b) {
			yA('sdl', 'init', !1) &&
				!mD() &&
				(b ? vc(C, 'scrollend', a) : vc(C, 'scroll', a),
				vc(C, 'resize', a),
				zA('sdl', 'init', !1));
		},
		iD = function () {
			var a = eD(),
				b = a.depthX,
				c = a.depthY,
				d = (b / fD.scrollWidth) * 100,
				e = (c / fD.scrollHeight) * 100;
			nD(b, 'horiz.pix', 'PIXELS', 'horizontal');
			nD(d, 'horiz.pct', 'PERCENT', 'horizontal');
			nD(c, 'vert.pix', 'PIXELS', 'vertical');
			nD(e, 'vert.pct', 'PERCENT', 'vertical');
			zA('sdl', 'pending', !1);
		},
		nD = function (a, b, c, d) {
			var e = gD(b),
		...
		oD = function () {
			...
			return function () {
				var c = Ss(),
					d = c.height;
				a = Math.max(fD.scrollLeft + c.width, a);
				b = Math.max(fD.scrollTop + d, b);
				return { depthX: a, depthY: b };
			};
		},
		mD = function () {
			return !!(
				Object.keys(gD('horiz.pix')).length ||
				Object.keys(gD('horiz.pct')).length ||
				Object.keys(gD('vert.pix')).length ||
				Object.keys(gD('vert.pct')).length
			);
		};
	function qD(a, b) {
		var c = this;
		...
		switch (d.horizontalThresholdUnits) {
			case 'PIXELS':
				hD(d.horizontalThresholds, b, 'horiz.pix');
				break;
			case 'PERCENT':
				hD(d.horizontalThresholds, b, 'horiz.pct');
		}
		switch (d.verticalThresholdUnits) {
			case 'PIXELS':
				hD(d.verticalThresholds, b, 'vert.pix');
				break;
			case 'PERCENT':
				hD(d.verticalThresholds, b, 'vert.pct');
		}
		yA('sdl', 'init', !1)
			? yA('sdl', 'pending', !1) ||
			  F(function () {
				...
				var n = a(),
					...
					r =
						k !== void 0
							...
							? 0
							: Math.round((q / p) * 100),
					u = E.hidden ? !1 : Ts(c) >= 0.5;
				d();
				var v = void 0;
				b !== void 0 && (v = [b]);
				var t = DA(c, 'gtm.video', v);
	...
	var xD = function (a, b, c) {
			var d = a.map(function (g) {
				return { Ja: g, lf: g, hf: void 0 };
			});
			if (!b.length) return d;
			var e = b.map(function (g) {
				return { Ja: g * c, lf: void 0, hf: g };
			});
		...
		AD = function (a, b) {
			...
			function f(I) {
				switch (I) {
					case 1:
						...
						y = a.getPlaybackRate();
						b.Ah ? lz(u.createEvent('start')) : u.zd();
						v = xD(b.ji, b.ii, a.getDuration());
						return g(I);
					default:
						return f;
				}
			...
			function k(I) {
				...
				switch (I) {
					...
					case 3:
						...
						J =
							Math.abs(((pb().getTime() - B) / 1e3) * y - H) > 1
								? 'seek'
								: J || 'buffering';
						a.getCurrentTime() &&
							(b.zh ? lz(u.createEvent(J)) : u.zd());
						q();
						return m;
					case -1:
						return e(I);
			...
			function n() {
				...
				b.yh && lz(u.createEvent('complete', 1));
				return e(-1);
			}
			function p() {}
			function q() {
				...
				if (v.length && y !== 0) {
					...
					c = function () {
						...
						v.length > 0 &&
							v[0].Ja === J.Ja &&
							(v.shift(),
							lz(u.createEvent('progress', J.hf, J.lf)));
						r();
					};
		...
		BD = function (a, b) {
			if (
				...
				(bc(a, 'data-gtm-yt-inspected-' + b.Ib), DD(a, b.Qe))
			) {
				a.id || (a.id = ED());
				var c = C.YT,
					d = c.get(a.id);
		...
		FD = function (a, b) {
			...
			for (var c = 0; c < uD.length; c++)
				if (a.indexOf('//' + uD[c] + '/' + b) >= 0) return !0;
			return !1;
		},
		ED = function () {
			var a = '' + Math.round(Math.random() * 1e9);
			return E.getElementById(a) ? ED() : a;
		};
	function GD(a, b) {
		var c = this;
		var d = function () {
		...
		var e = !!a.get('captureStart'),
			...
			k = zD(G(a.get('progressThresholdsPercent'))),
			m = yD(G(a.get('progressThresholdsTimeInSeconds'))),
		...
		F(function () {
			for (
				...
				if (FD(w, 'iframe_api') || FD(w, 'player_api')) return b;
			}
			for (
				...
				if (!wD && DD(x[A], p.Qe))
					return (
						pc('https://www.youtube.com/iframe_api'), (wD = !0), b
					);
		});
		return b;
	}
	...
	function sF() {
		...
		L(this, 'read_container_data'),
			S(43) && rF
				? (a = rF)
				: (a.set('containerId', 'G-NY24GPNB62'),
				  a.set('version', '1'),
				  a.set('environmentName', ''),
				  a.set('debugMode', Wf),
				  a.set('previewMode', Xf.Ek),
				  a.set('environmentMode', Xf.Ul),
				  a.set('firstPartyServing', cj() || Qi),
	...
	function MF(a, b) {
		...
		var d = vj(Bj(C.location.href), 'query'),
			e = uj(d, a, b);
		c = hd(e, this.D);
		return c;
	}
	...
	var bG = function (a) {
			...
			if (Array.isArray(b)) for (var c = 0; c < b.length; c++) aG(b[c]);
			var d = Wa('GA4_EVENT');
			d && (a.j._eu = d);
		},
		cG = function () {
	...
	var gG = function (a, b, c) {
		...
		kG = function (a) {
			...
			if (!d) {
				...
				e && e !== c && (d = ip(e, b.domain, b.path, jG, O.g.U));
			}
			return d;
		},
		hG = function (a, b) {
	...
	var nG = function (a, b, c) {
			...
			g.Qc = d.Qc + 1;
			var k;
			return (k = mG(g.sessionId, g.Qc, g.Nd, g.cf, g.Xh, g.Mc, g.Dd)) !=
				null
				? k
				: b;
		},
	...
	var tG = function (a) {
		...
		zG = function (a) {
			var b = tG(a) || {},
				...
				f = {};
			Np(b[O.g.Hc], !!b[O.g.X]) &&
				((f = vG(a, d, e)), f.clientId && f.Wa && (yG = !0));
			b[O.g.X] &&
				Kp(
					function () {
						var g = {},
						...
						var m = rG(a);
						m && (g[e] = m);
						var n = Qo('FPLC', void 0, void 0, O.g.U);
	...
	var AG = function (a) {
		if (!a.metadata.is_merchant_center && Ij(a.m)) {
			var b = tG(a) || {},
				c =
					(Np(b[O.g.Hc], !!b[O.g.X]) ? Dp(!0)._fplc : void 0) ||
					(Qo('FPLC', void 0, void 0, O.g.U).length > 0
						? void 0
						: '0');
			a.j._fplc = c;
		}
	...
	var GG = function (a, b) {
			Ao() &&
				((a.gcs = Bo()), b.metadata.is_consent_update && (a.gcu = '1'));
			a.gcd = Fo(b.m);
		...
		JG = function (a) {
			...
			if (cj()) return { url: '' + bj() + '/g/collect', endpoint: 16 };
			var c = Rt(a),
				d = V(a.m, O.g.sb);
		...
		RG = function (a, b, c) {
			...
			jb(a.j, function (v, t) {
				if (t !== void 0 && !oh.hasOwnProperty(v)) {
					...
					v !== O.g.ee
						? (w = !1)
						: a.metadata.euid_mode_enabled || Qt(a)
						? ((d.ecid = x), (w = !0))
						: (w = void 0);
					if (!w && v !== O.g.Hf) {
						var y = t;
	...
	var dH = function (a, b) {
		...
		gH = function (a, b, c, d) {
			...
			if (d && !XF) cH(g, c);
				...
				var k = b;
				Ec()
					? Dc(a + '?' + k, c, { noFallback: !0 }) ||
					  eH(a, dH(k, '_z=failedfetch'), c)
					: eH(a, dH(k, '_z=nofetch'), c);
			}
		},
		hH = function (a, b) {
			function c(v) {
			...
			if (d || e) {
				...
				a.Rc.uid &&
					!k &&
					n.push('uid=' + encodeURIComponent('' + a.Rc.uid));
				var p = function () {
					c('dma');
	...
	iH.prototype.add = function (a) {
		// console.log('iH.prototype.add ', a);
	...
	var mH = function (a, b, c) {
			...
			if (typeof b === 'object')
				for (
					var d = l(Object.keys(b)), e = d.next();
					!e.done;
					e = d.next()
				) {
					var f = e.value;
		...
		wH = function (a) {
			Qt(a) &&
				(a.metadata.speculative && Mt(a, 'sp', 1),
				a.metadata.is_syn && Mt(a, 'syn', 1),
				a.metadata.em_event && (Mt(a, 'em_event', 1), Mt(a, 'sp', 1)));
		},
		xH = function (a) {
			if (Qt(a)) {
				var b = Vi;
		...
		yH = function (a) {
			...
			if (Qt(a)) {
				var c = Nt(a, 'ccd_add_1p_data', !1) ? 1 : 0;
				Mt(a, 'ude', c);
				var d = V(a.m, O.g.Ga);
				d !== void 0
					? (b(d), (a.j[O.g.vd] = 'c'))
	...
	var FH = function (a, b) {
			...
			var e = c;
			return { clientId: iG(a, b), Wa: e };
		},
		GH = function (a, b, c, d, e) {
			var f = V(a.m, O.g.tb);
			if (V(a.m, O.g.Ob) && V(a.m, O.g.jc))
				f ? gG(a, f, 1) : (U(127), (a.isAborted = !0));
			else {
				var g = f ? 1 : 8;
	...
	var HH = window,
		IH = document,
		JH = function (a) {
			// console.log('JH = function (a) ', a);

			var b = HH._gaUserPrefs;

			if (
				(b && b.ioo && b.ioo()) ||
				IH.documentElement.hasAttribute(
					'data-google-analytics-opt-out'
				) ||
				(a && HH['ga-disable-' + a] === !0)
			) {
				// console.log('data-google-analytics-opt-out');
				return !0;
			}
			...
			try {
				...
				if (c && c._gaUserPrefs && c._gaUserPrefs == 'oo') {
					// console.log(
					// 	"c && c._gaUserPrefs && c._gaUserPrefs == 'oo'"
					// );
					return !0;
				}
			} catch (p) {
				// console.log('catch p', p);
			}

			// console.log('after try', String(IH.cookie).split(';'));
			...
			// console.log(
			// 	"IH.getElementById('__gaOptOutExtension')",
			// 	IH,
			// 	IH.getElementById('__gaOptOutExtension') ? !0 : !1
			// );
	...
	var LH = function (a) {
		...
		OH = function (a) {
			V(a.m, O.g.cb) &&
				(X(O.g.U) || V(a.m, O.g.tb) || (a.j[O.g.Hj] = !0));
			var b;
			var c;
			c = c === void 0 ? 3 : c;
	...
	h.Ym = function (a, b, c) {
		...
		if (e)
			if (c.eventMetadata.is_external_event && a.charAt(0) === '_')
				...
				if (Nt(f, O.g.Gc, V(f.m, O.g.Gc)) || k)
					g.push(O.g.O), g.push(O.g.N);
				Au(function () {
					// console.log('El');
					El(function () {
						// console.log('d.zm', d, d.Zm, f);
						d.Zm(f);
					}, g);
				});
				this.Wm(a, c, f);
	...
	h.Zm = function (a) {
		// console.log('h.Zm = function');

		var b = this;
		this.j = a;
		try {
			VH(a);
			// console.log('after VH(a);');
			WH(a);
			// console.log('after WH(a);');
			XH(a);
			YH(a);
			S(112) && (a.isAborted = !0);
			hs(a);
			...
			// console.log('this.bk(a);', a, window.cc.director);
			// window.cc.director.emit('Log', JSON.stringify(a));
			this.bk(a);
			a.m.onSuccess();
		} catch (f) {
			// console.log('h.Zm catch', f);
			window.cc.director.emit('Log', JSON.stringify(f.message));
			a.m.onFailure();
		}
		cG();
	};
		...
		if (!this.P) {
			...
			Cl([O.g.N, O.g.U], function () {
				...
				if (g) {
					...
					ry(v, a.m.eventId, { eventMetadata: m });
				}
				d = f;
				c = e;
			});
	...
	var XH = function (a) {
			...
			// console.log('XH location.protocol', b);
		...
		aI = function (a) {
			if (a.metadata.is_merchant_center)
				...
				Nt(a, 'ccd_add_1p_data', !1) ||
				Nt(a, 'ccd_add_ec_stitching', !1)
			)
					...
					c === null
						...
						: (b.enable_code &&
						  ...
						  Uc(b.selectors) &&
								...
								(a.metadata.user_data_from_manual = pj(
									b.selectors
								)));
				}
			}
		...
		iI = function (a) {
			...
			if (
				...
				var b = Rt(a);
				(a.metadata.is_session_start || V(a.m, O.g.Tg)) &&
		...
		VH = function (a) {
			// console.log('VH = function (a)', a);

			if (JH(a.target.destinationId)) {
				// console.log('JH(a.target.destinationId)', a);
				U(28);
				a.isAborted = !0;
			} else if (S(117)) {
				var b = ok();
				// console.log('b && Array.isArray(b.destinations)');
		...
		WH = function (a) {
			// console.log('WH = function (a) {');

			if (zu.Wl.replace(/\s+/g, '').split(',').indexOf(a.eventName) >= 0)
				a.isAborted = !0;
			else {
				var b = Ot(a);
	...
	function dJ(a) {
		...
		if (n.search)
			for (
				...
				var u = q[r].split('='),
					v = u[0],
					t = decodeURIComponent(u.splice(1).join('=')).replace(
						/\+/g,
						' '
					);
				p.hasOwnProperty(v)
	...
	KJ.getItem = function (a) {
		...
		var c = vA(this).kb();
		LJ[c] &&
			(b = LJ[c].hasOwnProperty('gtm.' + a) ? LJ[c]['gtm.' + a] : null);
		return b;
	};
	...
	KJ.removeItem = function (a) {
		L(this, 'access_template_storage');
		var b = vA(this).kb();
		if (!LJ[b] || !LJ[b].hasOwnProperty('gtm.' + a)) return;
		delete LJ[b]['gtm.' + a];
	};
	KJ.clear = function () {
		L(this, 'access_template_storage'), delete LJ[vA(this).kb()];
	};
	...
	(Z.securityGroups.detect_youtube_activity_events = ['google']),
		(function () {
			...
			(function (b) {
				...
				Z.__detect_youtube_activity_events.o =
					'detect_youtube_activity_events';
	...
	(Z.securityGroups.detect_history_change_events = ['google']),
		(function () {
			...
			(function (b) {
				...
				Z.__detect_history_change_events.o =
					'detect_history_change_events';
	...
	(Z.securityGroups.detect_form_interaction_events = ['google']),
		(function () {
			...
			(function (b) {
				...
				Z.__detect_form_interaction_events.o =
					'detect_form_interaction_events';
		...
		try {
			...
			if (a) {
				...
				if (ak().canonical[g]) {
					...
					Cu();
					aj.j = '101823848~101925629~102017403';
					aj.K = '';
					aj.Ua =
